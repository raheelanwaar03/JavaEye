    ...
    <div class="wrapper homepage">
        ...
        <div class="header">
            <div class="row no-gutters">
                ...
                <div class="col text-center"><img src="{{ asset('asset/img/logo-header.png') }}" alt=""
            ...
            <div class="row">
                <div class="swiper-container icon-slide mb-4">
                    <div class="swiper-wrapper">
                        <a href="#" class="swiper-slide text-center" data-toggle="modal"
                ...
                <div class="card-footer border-top bg-none">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-default btn-rounded-36 shadow-sm" type="button"
                                id="button-addon4"><i class="material-icons md-18">send</i></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center pt-0">
                    <img src="{{ asset('asset/img/infomarmation-graphics2.png') }}" alt="logo"
                        class="logo-small">
